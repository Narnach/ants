...
* Height map bot: use height maps to let ants flow towards food and away from enemies. Put food at depth 3/decay 1, enemy ants at height 3/decay 1, friendly ants at height 2/decay 1, water at height 10/decay 0. Decay indicates how much height is lost based on distance, or how wide of a crater/mountain something makes. Ants will move towards the lowest nearby tile. Use randomized movement for tie-breaking.
